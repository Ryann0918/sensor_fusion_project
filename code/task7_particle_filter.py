...
plt.savefig(os.path.join(output_dir, "task7_particle_filter_result.png"), dpi=150, bbox_inches='tight')
print(f"\nSaved: task7_particle_filter_result.png")

np.savetxt(os.path.join(output_dir, "task7_particle_filter_trajectory.csv"), trajectory, 
           delimiter=',', header='x,y,phi', comments='')
print("Saved: task7_particle_filter_trajectory.csv")
